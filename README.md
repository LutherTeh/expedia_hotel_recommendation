...
We expect the solution file to have 2,528,243 predictions. The file should have a header row. Please see the sample submission file on the data page for an example of a valid submission.
